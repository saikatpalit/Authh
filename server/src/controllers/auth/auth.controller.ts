...
const verifyUrl = `${getFrontendUrl()}/email-verify?token=${verifyToken}`;
...
export async function loginHandler(req: Request, res: Response) {
  try {
    ...
    console.log("twoFactorEnabled:", user?.twoFactorEnabled, "twoFactorSecret:", !!user?.twoFactorSecret);
...
console.log("User email:", user.email);
    ...
    console.log("Saved Secret In DB:", user.twoFactorSecret);
...
export async function twoFAVerifyHandler(req: Request, res: Response) {
  ...
  console.log("Incoming 2FA Code:", code);
...
console.log("2FA Enabled before verification:", user?.twoFactorEnabled);
...
console.log("2FA Enabled Saved:", user.twoFactorEnabled);
